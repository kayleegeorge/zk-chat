...
export default class ChatApp {
    ...
    constructor(appName: string, onChain?: Contract, provider?: Web3Provider, rlnIdentifier?: bigint);
    registerUserOnChain(): Promise<import("@semaphore-protocol/identity").Identity | undefined>;
